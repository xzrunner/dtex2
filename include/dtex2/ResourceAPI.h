...
public:
	struct Callback
	{
		...
		void (*load_file)(const std::string& filepath, bool async, void (*parser_cb)(const void* data, size_t size, void* ud), void* ud);
	...
	static void LoadFile(const std::string& filepath, bool async, void (*parser_cb)(const void* data, size_t size, void* ud), void* ud);
